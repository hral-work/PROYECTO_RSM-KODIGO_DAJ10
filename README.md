...
Toda la información recopilada para el entregable No. 1, procedimientos, scripts y demas datos referentes al dimiensionamiento del analisis y solucion de requerimientos han sido plasmados en el documento ANALISIS_RSM_KODIGO_DAJ10_AVANCE_1.pdf
...
Toda la información recopilada para el entregable No. 2, procedimientos, scripts y demas datos referentes al dimiensionamiento del analisis y solucion de requerimientos han sido plasmados en el documento ANALISIS_RSM_KODIGO_DAJ10_AVANCE_2.pdf
